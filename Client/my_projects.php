...
<!-- Add Project Popup -->
<div id="project_modal" class="fixed inset-0 bg-gray-900 bg-opacity-75 flex items-center justify-center">
    <div id="modal_content" class="flex flex-col w-11/12 md:w-5/12 overflow-y-auto scrollbar-hidden mx-auto mt-10 p-4 bg-gray-200 rounded-sm shadow-lg">
        ...
        <!-- Add Project Form -->
        <form method="POST" action="projects.php" id="project_form" class="mt-[25%] md:px-10">
            <!-- Project Title -->
