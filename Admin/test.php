            ...
            <section class="p-8 antialiased md:py-16">
                <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
                    ...
                    <div class="grid gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                        <div class="flex items-center rounded-lg border border-gray-200 bg-white px-4 py-4 hover:bg-gray-50">
...
<div id="add_category_modal" class="hidden fixed inset-0 bg-gray-900 bg-opacity-75 flex items-center justify-center">
    <div id="add_modal_content" class="flex flex-col w-11/12 lg:w-1/3 md:w-2/3 h-5/6 overflow-y-auto scrollbar-hidden mx-auto mt-10 p-4 bg-gray-200 rounded-sm shadow-lg">
        ...
        <form method="POST" action="categories.php" class="mt-[25%] md:px-10">
            ...
            <div class="flex items-end justify-between w-full mb-5">
                <h3 class="text-gray-900 font-semibold mt-5">Subcategories:</h3>
            ...
            <div id="sub_cats_container">
                <div class="flex w-full sub_cat mb-2">
                    <label for="sub_category" class="text-gray-900 font-semibold w-1/3"></label>
                    <input type="text" name="sub_category[]" class="sub_category_input w-2/3">
...
<script>
    ...
    // =============================================================
        const addSubCatButton = document.querySelector('.add_sub_cat');
        const subCatContainer = document.querySelector('.sub_cat');

        addSubCatButton.addEventListener('click', function (e) {        
            // Create the new subcategory field (as an HTML element, not just a string)
            const newSubCatField = document.createElement('div');
            newSubCatField.classList.add('flex', 'w-full', 'sub_cat','mb-2');
            
            // Set the inner HTML for the new subcategory field
            newSubCatField.innerHTML = `
                <label for="sub_category" class="text-gray-900 font-semibold w-1/3"></label>
                <input type="text" name="sub_category[]" class="sub_category_input w-2/3">
                <button  name="remove_sub_cat">
                    <svg width="25" height="25" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M10 11V17" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M14 11V17" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M4 7H20" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            ...
            // Append the new subcategory field to the container
            document.getElementById("sub_cats_container").appendChild(newSubCatField);
        });
</script>
