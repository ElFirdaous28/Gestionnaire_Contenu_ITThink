            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST"){
                if (isset($_POST['signup'])) {
                    ...
                    try {
                        ...
                        $result = $conn->prepare("INSERT INTO utilisateurs (nom_utilisateur, mot_de_passe, email, role) VALUES (?, ?, ?, ?)");
                        $result->execute([$full_name, $hashed_password, $email, $role]);
        ...
        <div class="md:flex w-full">
            ...
            <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
                ...
                <div class="flex items-center justify-center mt-2">
                    ...
                    <a href="login.php" class="text-indigo-500 ml-2">Log In</a>
                </div>
            </div>
        </div>
    </div>
